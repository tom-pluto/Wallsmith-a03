...
public class Solution25 {
    ...
    public static void main(String[] args) {
        ...
        String string = solution.getString();               //Call getString() to prompt and get string from console

        int strength = solution.passwordValidator(string);           //Call passwordValidator() and store resulting number

        String output = solution.createOutput(string, strength);     //Call createOutput() to generate the output in a string
    ...
    public int passwordValidator(String string){
        ...
        //Determine what "strength" the string has and return it
        return getStrength(hasNumber, hasLetter, hasSpecialCharacter, hasEightCharacters);
    }

    private int getStrength(boolean hasNumber, boolean hasLetter, boolean hasSpecialCharacter, boolean hasEightCharacters) {
    ...
    private String createOutput (String string, int strength){
